...
/** Dedicated public demo video, managed separately from lesson videos. */
export const demoVideoUpload = build({ maxMb: env.MAX_VIDEO_UPLOAD_MB, rules: { video: 'video/' }, files: 1 }).single('video')
